	...
	public int longestWPI(int[] hours) {
		...
		for(int i=0;i<hours.length;i++){
			...
			*/
			...
			2)else don't include that day and next day in our answer as excluding that will 
			lead to (tiring-nontiring)=1 .And update prefix sum's index with  current index as 
			previouly seen prefixsum's index is a non tiring day 
